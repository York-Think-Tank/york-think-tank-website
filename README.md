...
### How to run Strapi for developmentent-system`
1. clone the repo
2. Install docker and docker compose
3. cd into `content-management-system`
4. Run `npm install` to install the dependencies
5. Run `docker compose up` in the root of the repo
6. Open `http://localhost:1337/admin` in your browser to access the Strapi
7. Your changes will be in the `scr/api/` so need to commit that to the repo
